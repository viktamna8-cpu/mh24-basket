...
const CATEGORIES = [
  { id: "daily", mr: "रोजच्या भाज्या", en: "Daily Vegetables", img: "https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=400&q=80" },
  { id: "leafy", mr: "पालेभाज्या", en: "Leafy Vegetables", img: "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400&q=80" },
  { id: "seasonal", mr: "हंगामी भाज्या", en: "Seasonal Vegetables", img: "https://images.unsplash.com/photo-1447175008436-054170c2e979?w=400&q=80" },
  { id: "piece", mr: "नगावर मिळणाऱ्या वस्तू", en: "Piece Items", img: "https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=400&q=80" },
];
...
const IMG = {
  ...
  radish: "https://images.unsplash.com/photo-1584618301100-8b6d7bd18e93?w=400&q=80",
  cucumber: "https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400&q=80",
  bottlegourd: "https://images.unsplash.com/photo-1622206151226-18ca2c9d680c?w=400&q=80",
  bittergourd: "https://images.unsplash.com/photo-1609501676725-7186f017a4b7?w=400&q=80",
  ridgegourd: "https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=400&q=80",
  ladyfinger: "https://images.unsplash.com/photo-1657544586595-7cc4f8ca7c31?w=400&q=80",
  brinjal: "https://images.unsplash.com/photo-1600684626840-056bd23f5c25?w=400&q=80",
  cauliflower: "https://images.unsplash.com/photo-1568584711271-c3f2c3f7f0e0?w=400&q=80",
  ...
  greenchilli: "https://images.unsplash.com/photo-1583119022894-919a68a3d0e3?w=400&q=80",
  ...
  ivygourd: "https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=400&q=80",
  ...
  mushroom: "https://images.unsplash.com/photo-1611040521310-fa6a1a4b9b5c?w=400&q=80",
  pumpkin: "https://images.unsplash.com/photo-1509618434313-84cf5cb6f2ff?w=400&q=80",
  methi: "https://images.unsplash.com/photo-1622205313162-be1d5712a43c?w=400&q=80",
...
const PRODUCTS = [
  ...
  P("पडवळ", "Snake Gourd", "daily", "weight", 3, IMG.ridgegourd),
  ...
  P("गवार", "Cluster Beans", "daily", "weight", 3, IMG.frenchbeans),
  P("शेवगा", "Drumstick", "daily", "weight", 3, IMG.drumstick),
  P("तोंडली", "Ivy Gourd", "daily", "weight", 3, IMG.ivygourd),
  P("वाल पापडी", "Hyacinth Beans", "daily", "weight", 3, IMG.frenchbeans),
  ...
  P("शेपू", "Dill", "leafy", "pendi", 3, IMG.methi),
  P("तांदुळजा", "Amaranth", "leafy", "pendi", 3, IMG.spinach),
  P("चाकवत", "Chakvat", "leafy", "pendi", 3, IMG.spinach),
  P("अंबाडी", "Ambadi", "leafy", "pendi", 3, IMG.spinach),
  P("कढीपत्ता", "Curry Leaves", "leafy", "pendi", 2, IMG.curryleaves),
  P("करडईची भाजी", "Safflower Leaves", "leafy", "pendi", 3, IMG.spinach),
...
const GREEN = "#1F6B3A";
const CREAM = "#FAF8F0";function StockBadge({ inStock }) {
  return inStock ? (
    ...
    <div className="pb-40">
      ...
      <div className="px-4 pt-3 space-y-3">
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 mt-4">
          ...
          <div className="flex justify-between text-sm text-gray-700"><span>Weekly Service / Delivery Fee</span><span className="font-semibold">₹{DELIVERY_FEE}</span></div>
        </div>
...
function DetailsScreen({ details, setDetails, setScreen }) {
  ...
  return (
    <div className="pb-28 px-4">
      <div className="pt-5 pb-2 flex items-center gap-3" style={{ backgroundColor: CREAM }}>
        <button onClick={() => setScreen("basket")}><ArrowLeft size={20} /></button>
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-100 p-3 z-40">
        <button disabled={!canContinue} onClick={() => { setDetails(form); setScreen("confirm"); }} className={`w-full py-3 rounded-full font-bold text-sm text-white ${canContinue ? "" : "opacity-40"}`} style={{ backgroundColor: GREEN }}>पुढे जा / Continue</button>
      </div>
    </div>
  );
}
...
function buildWhatsAppMessage(cart, products, details) {
  ...
  msg += `Weekly Service / Delivery Fee: ₹${DELIVERY_FEE}\n`;
  if (details.note) msg += `\nSpecial Note:\n${details.note}\n`;
  msg += `\n${DISCLAIMER}`;
  return msg;
}
    ...
    <div className="pb-32 px-4">
      ...
      <div className="pt-3 space-y-3">
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4">
          ...
          <div className="flex justify-between text-sm"><span>Weekly Service / Delivery Fee</span><span className="font-semibold">₹{DELIVERY_FEE}</span></div>
        </div>
        <p className="text-[11px] text-gray-400 px-1">{DISCLAIMER}</p>
      </div>
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-100 p-3 z-40">
  ...
  return (
    <div className="px-4 pt-10 pb-10 flex flex-col items-center text-center">
      ...
      <div className="w-full bg-emerald-50 border border-emerald-100 rounded-2xl p-4 mt-4">
        ...
        <div className="text-xs text-gray-500 mt-1">Weekly service/delivery fee: ₹{DELIVERY_FEE}</div>
      </div>
...
export default function MH24BasketApp() {
  ...
  const [details, setDetails] = useState({ name: "", mobile: "", society: "", flat: "", address: "", landmark: "", note: "" });
  ...
  else if (screen === "details") content = <DetailsScreen details={details} setDetails={setDetails} setScreen={setScreen} />;
